...
class _RestClient implements RestClient {
  ...
  Future<UploadProductResponse> addProduct({
    ...
    required UploadProductRequest request,
  }) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'x-auth-token': token};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UploadProductResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UploadProductResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<CreateOrUpdateShippingInfoResponse> createAddress({
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CreateOrUpdateShippingInfoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CreateOrUpdateShippingInfoResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<DeleteOrUpdateCardResponse> deleteCardById({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DeleteOrUpdateCardResponse>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = DeleteOrUpdateCardResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<GetProductsResponse> getMyWishlist({required String token}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'x-auth-token': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<UpdateWishlistResponse> createOrUpdateWishlist({
    required String token,
    required UpdateWishlistRequest request,
  }) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'x-auth-token': token};
